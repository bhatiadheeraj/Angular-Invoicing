...
.constant('DEFAULT_LOGO', 'images/new_logo.png')
...
.constant('DEFAULT_INVOICE', {
  ...
  customer_info: {
    ...
    web_link: 'dsdsd.',
    address1: 'Saket ',
    address2: 'Indore,Mp,India',
    postal: '452001'
  },
  company_info: {
    name: 'Saral Hai',
    web_link: 'www.saralhai.com',
    address1: '123 falana dhimka',
    address2: 'Indore, MP, India',
    postal: '452001'
  },
  items:[
    { qty: 10, description: 'Potato', cost: 9.95 }
  ]
})
...
.controller('InvoiceCtrl', ['$scope', '$http', 'DEFAULT_INVOICE', 'DEFAULT_LOGO', 'LocalStorage', 'Currency',
  ...
  $scope.clearLocalStorage = function() {
    ...
    $http.get("http://fraycraft.tk/sh/app/get.php?get=stores")
    .then(function (response) {$scope.availableTags = response.data;
        console.log(response.data);
    });


  //autocomplete test for store name ; 
